...
function Todos(props) {
  ...
  const clearAll = () => {
    console.log(todos);
    if (todos.length === 0) setVisible(true);
    else{
        setTodos([]);
      ...
      <div className="container-fluid">
        <Modal isOpen={modal}>
            ...
            <div className="row text-center">
              <div className="col-xs-12 col-sm-12">
                <input
                  ...
                  className={classnames("w-75 m-auto form-control", {
                    "is-invalid": error
                  })}
                  maxLength="32"
                />
          ...
          <ModalFooter>
            ...
            <Button color="primary" outline onClick={() => confrimEdit()}>
              Done
            </Button>
          </ModalFooter>
        </Modal>
        ...
        <div className="row text-center">
          <div className="col-xs-12 offset-sm-4 col-sm-4 col-md-4">
            <input
              ...
              value={todo}
              onChange={e => handleChange(e)}
              className={classnames("w-100 p-1 form-control", {
                "is-invalid": error
              })}
              maxLength="32"
            />
            ...
            <button onClick={clearAll} type="button" className="btn btn-danger">
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <button
                          ...
                          className="btn btn-danger mx-1 del-btn"
                        >
                          <i className="fa fa-trash"></i>
                        </button>
                        <button
                          onClick={() => editTodo(index)}
                          className="btn btn-success mx-1 edit-btn"
                        >
